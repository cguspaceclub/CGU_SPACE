    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="fixed inset-0 z-50 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 animate-orbit opacity-40">
          <div className="w-10 h-10 bg-gradient-to-r from-brand-orange to-brand-red rounded-full shadow-2xl animate-pulse"></div>
        </div>
        <div className="absolute bottom-1/4 left-1/4 animate-orbit-reverse opacity-30">
          <div className="w-8 h-8 bg-gradient-to-r from-brand-red to-brand-light-orange rounded-full shadow-2xl animate-bounce"></div>
        </div>

        {/* Floating Particles */}
        <div className="absolute top-16 right-16 animate-float-up opacity-60">
          <div className="text-2xl animate-spin-slow">✨</div>
        </div>
        <div className="absolute bottom-32 left-16 animate-float-down opacity-50">
      ...
      <section
        id="get-involved"
        className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden mt-32"
      >
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <img
